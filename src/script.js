  ...
  for (let i = 0; i < jobList.length; i++) {
    ...
    list.innerHTML += `
        <div class="grid ${gridGap} relative bg-white text-[#5ba4a4] font-bold py-8 px-6 rounded-md shadow-md">
            ...
            <!-- Item Start -->
            <img
            class="absolute top-[-1.5rem] left-6 w-12"
            src=${jobList[i].logo}
            ...
            <div class="flex items-center gap-2">
                <span class="${newLogo} bg-[#5ba4a4] text-white text-xs uppercase py-1 px-2 rounded-full tracking-tighter">New!</span>
                <span class="${boxDecoration} bg-[#2c3a3a] text-white text-xs uppercase py-1 px-2 rounded-full tracking-tighter">Featured</span>
            </div>
            </div>
